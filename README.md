...
Нашёл! Вот твой Voice ID для голоса "Sasha Mois - Voice 1" в HeyGen:
zyMUalnkbbh9kXJD64WH
Как я его нашёл — и как ты можешь сделать это сам в следующий раз:
Зайди в Avatar → Avatars → выбери аватар Sasha Mois
Нажми на иконку звуковых волн (рядом с именем аватара)
В открывшемся окне "Voice for Sasha Mois" нажми на иконку стрелок рядом с именем голоса → выбери "All voices →"
Нажми три точки (...) рядом с нужным голосом → "Get Voice ID" — ID скопируется в буфер обмена
Голос использует движок ElevenLabs, Multilingual, Female.
​
---
